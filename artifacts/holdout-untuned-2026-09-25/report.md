...
Repetitions: 1. Schedule seed: 11.
...
| shared/loki | 25/48 | 10/48 | 11/48 | 17/48 | 13/96 | 0 |
...
| --- | --- | ---: | ---: | ---: |
| shared/interlinked | first-invocation | 111.21 / 155.08 | 182.43 / 6003.95 | 293.19 / 6131.74 |
| shared/interlinked | startup-warmed | not measured | not measured | not measured |
| shared/loki | first-invocation | 106.56 / 550.01 | 751.70 / 3865.28 | 873.00 / 3967.53 |
...
- loki: `holdout/javascript/exec-thumbnail-command/defect` step 0: missed.
...
- loki: `holdout/python/webhook-signature-eq/defect` step 0: missed.
...
- loki: `holdout/elixir/system-cmd-sh-c/defect` step 0: missed.
- loki: `holdout/typescript/postmessage-missing-origin-check/defect` step 0: missed.
...
- loki: `holdout/rust/sh-c-image-resize/defect` step 0: missed.
...
- loki: `holdout/typescript/non-exhaustive-shipping-switch/defect` step 0: missed.
...
- loki: `holdout/go/defer-close-in-loop/defect` step 0: missed.
...
- loki: `holdout/typescript/nullish-port-type-mismatch/defect` step 0: missed.

## False blocks and instability

- shared/loki: `holdout/typescript/postmessage-missing-origin-check/control` step 0: false_post_block.
- shared/loki: `holdout/go/defer-close-in-loop/control` step 0: false_post_block.
- shared/loki: `holdout/typescript/hardcoded-stripe-secret/control` step 0: false_post_block.
- shared/loki: `holdout/typescript/deep-merge-prototype-pollution/control` step 0: false_post_block.
- shared/loki: `holdout/typescript/login-open-redirect/control` step 0: false_block.
- shared/interlinked: `holdout/typescript/innerhtml-comment-render/control` step 0: false_block.
- shared/loki: `holdout/python/subprocess-shell-backup/control` step 0: false_block.
- shared/loki: `holdout/python/sql-fstring-like-query/control` step 0: false_block.
- shared/loki: `holdout/go/sprintf-sql-query/control` step 0: false_post_block.
- shared/loki: `holdout/typescript/numeric-sort-without-comparator/control` step 0: false_post_block.
- shared/loki: `holdout/go/unchecked-json-unmarshal/control` step 0: false_post_block.
- shared/loki: `holdout/go/report-download-traversal/control` step 0: false_post_block.
